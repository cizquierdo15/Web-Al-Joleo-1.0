            ...
            <section class="home" id="home">
                <div class="home__container bd-container bd-grid">
                    <div class="home__data">
                        <h1 class="home__title"><img src="./assets/img/logoFinalConShadow3.png" alt="" class="logo_index"></h1>
                        <h2 class="home__subtitle">Restaurante en <br> un entorno idílico.</h2>
                        <a href="../Vista/instalaciones.php" class="button">Mostrar Instalaciones </a>
                    </div>
    
                    <img src="./assets/img/imagenPrueba.jpeg" alt="" class="home__img">
                </div>
            </section>
            </div>
            <!--========== Sobre nosotros ==========-->
            <section class="about section bd-container" id="about">
                <div class="about__container  bd-grid">
                    <div class="about__data">
                        ...
                        <h2 class="section-title about__initial">Comida natural <br> hecha con cariño</h2>
                        <p class="about__description">Restaurante de carne, Portuguesa, Mediterránea, Barbacoa, Europea, Española. <br> Comidas, Cenas y Desayunos</p>
                        <a href="../Vista/carta.php" class="button">Mostrar Carta</a>
                    </div>

                    <img src="./assets/img/prueba2.jpg" alt="" class="about__img">
                </div>
            </section>
            <!--========== Servicios ==========-->
            <section class="services section bd-container" id="services">
                ...
                <div class="services__container  bd-grid">
                    <div class="services__content">
                        <svg class="services__img" xmlns="http://www.w3.org/2000/svg"> <!--ICONOS-->
                        ...
                        <h3 class="services__title">Comida casera</h3>
                        <p class="services__description">Ofrecemos comida casera de primera calidad y hecha con mucho cariño.</p>
                    </div>
                    <div class="services__content"><!--ICONOS-->
                        ...
                        <h3 class="services__title">Para todos los publicos</h3>
                        <p class="services__description">Pese a que se nos conoce por nuestro asador, tenemos una gran variedad de productos que se adaptan a todos los publicos.</p>
                    </div>
                    <div class="services__content">
                        <svg class="services__img" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0)">
                        ...
                        <h3 class="services__title">Envío</h3>
                        <p class="services__description">Si el pedido cumple las condiciones oportunas podra ser enviado a domicilio sin coste extra.</p>
                    </div>
                </div>
            </section>
            <!--========== Menu de la semana ==========-->
            <section class="menu section bd-container" id="menu">
                <span class="section-subtitle">Menu Especial</span>
                <h2 class="section-title">Menu de la semana</h2>
                <span class="section-subtitle">Precio total: 12.00€</span>

                <div class="menu__container bd-grid">
                    <div class="menu__content">
                        <img src="../Vista/assets/img/ensalada.jpg" alt="" class="menu__img">
                        <h3 class="menu__name">Ensalada Al - Joleo</h3>
                        <span class="menu__detail">Queso de cabra, nueces, vinagreta y mostaza-miel</span>
                    </div>

                    <div class="menu__content">
                        <img src="../Vista/assets/img/solomillo.jpg" alt="" class="menu__img">
                        <h3 class="menu__name">Solomillo de cerdo</h3>
                        <span class="menu__detail">500g de Solomillo en salsa de pimienta verde con cebolla</span>
                    </div>
                    
                    <div class="menu__content">
                        <img src="../Vista/assets/img/tarta.jpeg" alt="" class="menu__img">
                        <h3 class="menu__name">Tarta de queso</h3>
                        <span class="menu__detail">Tarta de queso casera con frutos rojos y helado de mora</span>
                    </div>              
                </div>
            </section>
            <!--===== App =======-->
            <section class="app section bd-container">
                <div class="app__container bd-grid">
                    <div class="app__data">
                        ...
                        <h2 class="section-title app__initial">Descarga nuestra aplicacion</h2>
                        <p class="app__description">Descarga nuestra aplicacion y podrás realizar reservas, pedir comida, comprobar el estado de tu pedido y mucho mas.</p>
                        <div class="app__stores">
                            <a href="https://www.apple.com/es/app-store/"><img src="../Vista/assets/img/app1.png" alt="" class="app__store"></a>
                            <a href="https://play.google.com/store/apps?gl=ES&utm_source=emea_Med&utm_medium=hasem&utm_content=Oct2020&utm_campaign=Evergreen&pcampaignid=MKT-EDR-emea-es-1001280-Med-hasem-ap-Evergreen-Oct2020-Text_Search_SKWS%7cONSEM_kwid_43700007365263110&gclid=Cj0KCQjw4uaUBhC8ARIsANUuDjVxCQUsASfHU4JPr0TmTZMrd90I8dl7pUL9L4SRtJh2j93EZqZWMS8aAqIVEALw_wcB&gclsrc=aw.ds"><img src="../Vista/assets/img/app2.png" alt="" class="app__store"></a>
                        </div>
                    </div>

                    <img src="../Vista/assets/img/movil-app3.png" alt="" class="app__img" style="box-shadow:none;">
                </div>
            </section>
        </main>
        <!--========== FOOTER ==========-->
